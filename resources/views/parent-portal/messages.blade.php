...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-lg font-heading font-bold text-navy-700 mb-4">{{ __('Send Message to Homeroom Teacher') }}</h2>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-lg font-heading font-bold text-navy-700">{{ __('Message History') }}</h2>
        </div>
        ...
        <div class="divide-y divide-gray-100">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium {{ $msg->is_from_parent ? 'bg-gold-100 text-gold-700' : 'bg-navy-100 text-navy-700' }}">
                                {{ $msg->is_from_parent ? __('You') : ($msg->sender_name ?? __('Teacher')) }}
                            </span>
            ...
            <div class="p-12 text-center">
                ...
                <p class="text-gray-400">{{ __('No message history.') }}</p>
            </div>
            @endforelse
        </div>
    </div>
