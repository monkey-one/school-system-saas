...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center gap-4">
        <div class="w-12 h-12 rounded-full bg-navy-100 flex items-center justify-center text-navy-600 font-bold text-lg">
            {{ strtoupper(substr($selectedChild->full_name, 0, 1)) }}
        </div>
        <div>
            <h3 class="font-heading font-bold text-navy-600">{{ $selectedChild->full_name }}</h3>
