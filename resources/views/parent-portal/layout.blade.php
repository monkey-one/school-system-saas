...
<head>
    ...
    <title>@yield('title', __('Parent Portal')) - EduSaaS</title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center gap-3 px-6 py-5 border-b border-white/10">
                ...
                <div>
                    ...
                    <span class="block text-xs text-white/50">{{ __('Parent Portal') }}</span>
                </div>
            </div>
            ...
            <div class="px-4 py-4 border-b border-white/10">
                <label class="text-xs text-white/40 uppercase tracking-wider font-semibold block mb-2">{{ __('Select Child') }}</label>
            ...
            <nav class="px-4 py-6 space-y-1">
                @php
                    ...
                    $navItems = [
                        ['route' => 'parent.dashboard', 'params' => [], 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>', 'label' => __('Dashboard')],
                        ['route' => 'parent.attendance', 'params' => ['student' => $studentId], 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>', 'label' => __('Child Attendance')],
                        ['route' => 'parent.grades', 'params' => ['student' => $studentId], 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>', 'label' => __('Grades')],
                        ['route' => 'parent.spp', 'params' => ['student' => $studentId], 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>', 'label' => __('Pay Tuition')],
                        ['route' => 'parent.messages', 'params' => [], 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>', 'label' => __('Messages')],
                    ];
                @endphp
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="{{ route('locale.switch', app()->getLocale() === 'id' ? 'en' : 'id') }}" class="text-xs font-medium text-gray-400 hover:text-gray-600 border border-gray-200 rounded-lg px-2 py-1">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="hidden sm:block">
                                <div class="text-sm font-semibold text-gray-800">{{ $parent->name ?? __('Parent') }}</div>
                                <div class="text-xs text-gray-400">{{ __('Parent / Guardian') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
